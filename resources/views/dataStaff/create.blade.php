        ...
        <div class="col-sm-12 col-md-12">
            <div class="card card-accent-dark">
                <div class="card-header">
                    <strong> Form Input Staff Baru </strong>
                </div>
                <div class="card-body">
                    <form action="{{route('datastaff.store')}}" class="form-horizontal" method="POST" id="formInsertStaff">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control @error('fullname') is-invalid @enderror" id="fullname" name="fullname" type="text" placeholder="Nama Lengkap" value="{{old('fullname')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control @error('email') is-invalid @enderror" id="email" name="email" type="email" placeholder="Email" value="{{old('email')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" type="number" placeholder="Nomor Telepon (Mohon hanya isi dengan angka)" value="{{old('phone_number')}}">
                ...
                <div class="card-footer">
                    <div class="float-right">
                        <button class="btn btn-success" type="submit" id="btn-submit" form="formInsertStaff"> Submit </button>
                    </div>
                </div>
            </div>
        </div>
